...
namespace Fofx
{
    public class RelationshipArrayStringValueRequestHelper : BaseRelationshipRevisableRequestHelper
    {
        ...
        protected override void Read(int[] entities, int[] timeseries, int[] relationship, DatabaseRequestArgs args, TimeSeriesDatabaseContext requester, Dictionary<QuickID, ITimeSeriesKey> keys, SortedList<ITimeSeriesKey, ITimeSeries> dbTimeSeriesResult)
        {
            ...
            ReadHelper.ReadByType<TextConstituentArrayTimeSeries>(entities, timeseries, relationship, args, requester, keys, dbTimeSeriesResult, reader);
