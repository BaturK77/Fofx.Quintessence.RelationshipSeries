...
namespace Fofx
{
    public class RelationshipArrayNumericValueRequestHelper : BaseRelationshipRevisableRequestHelper
    {
        ...
        protected override void Read(int[] entities, int[] timeseries, int[] relationship, DatabaseRequestArgs args, TimeSeriesDatabaseContext requester, Dictionary<QuickID, ITimeSeriesKey> keys, SortedList<ITimeSeriesKey, ITimeSeries> dbTimeSeriesResult)
        {
            ...
            ReadHelper.ReadByType<NumericConstituentArrayTimeSeries>(entities, timeseries, relationship, args, requester, keys, dbTimeSeriesResult, reader);
        }
