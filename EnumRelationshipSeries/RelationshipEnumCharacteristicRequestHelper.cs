...
namespace Fofx
{
    public class RelationshipEnumCharacteristicRequestHelper : BaseRelationshipRevisableRequestHelper
    {
        public override INullableReader GetDataReader(int[] entites, int[] factors, int[] relationships, DatabaseRequestArgs args)
        {
            ...
            return DataAccess.GetDataReader("[TimeSeries].[RelationshipCharacteristicEnumTimeseriesLoad]", parameters);
        }
        ...
        {
            StringCharacteristicRevisableTimeSeries ncs = null;
            ...
            Revision<CharacteristicTextPoint> revisionCollection = null;
            CharacteristicTextPoint constituentPoint = null;
            ...
            using (INullableReader reader = GetDataReader(entities, timeseries, relationship, args))
            {
                while (reader.Read())
                {
                    ...
                    if (entityID != previousEntityID || previousTimeSeriesValueID != timeSeriesValueID || previousRelationshipValueID != relationshipValueID)
                    {
                        ...
                        revisionCollection = new Revision<CharacteristicTextPoint>(valueDate);
